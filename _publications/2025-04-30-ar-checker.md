...
citation: |
  **Zeguan Xiao**, Siqing Li, Yong Wang, Xuetao Wei, Jian Yang, Yun Chen, Guanhua Chen. Modeling LLM Unlearning as an Asymmetric Two-Task Learning Problem. In *Proceedings of the 63rd Annual Meeting of the Association for Computational Linguistics (ACL)*, 2026.
---
